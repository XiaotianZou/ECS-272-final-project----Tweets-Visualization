...
function initOverview() {
    ...
    overviewSVGLayer1 = overviewSVG.append('g')
        .attr('transform', 'translate(' + overviewMargin.left + ', ' + overviewMargin.top + ')')
    overviewSVGLayer2 = overviewSVG.append('g')
        .attr('transform', 'translate(' + overviewMargin.left + ', ' + overviewMargin.top + ')')
...
function onChangeOverview() {
    ...
    overviewSVGLayer1.selectAll('.overviewStream')
    ...
    var line = d3.line()
        ...
        .curve(d3.curveMonotoneX)
    overviewSVGLayer2.append('path')
        .datum(avgValenceByCluster)
        .attr('class', '.overviewLine')
        .attr('d', line)
        .style('fill', 'transparent')
        .attr('stroke', 'black')
    overviewSVGLayer2.selectAll('.overviewDot')
